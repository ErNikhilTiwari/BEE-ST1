  ...
  return (
    <div className='p-4 bg-slate-800 h-screen'>
      ...
      <div className='flex flex-col border-2 border-sky-600 rounded-xl w-[600px] p-4 mx-auto'>
        <div className='my-4'>
          <label className='text-xl mr-4 text-gray-500 text-neutral-100'>Title</label>
          <input
            type='text'
            value={title}
        ...
        <div className='my-4'>
          <label className='text-xl mr-4 text-gray-500 text-neutral-100'>Author</label>
          <input
            type='text'
            value={author}
        ...
        <div className='my-4'>
          <label className='text-xl mr-4 text-gray-500 text-neutral-100'>Publish Year</label>
          <input
            type='number'
            value={publishYear}
